...
/*!*********************************************!*\
  !*** ./frontend/actions/session_actions.js ***!
  \*********************************************/
/*! exports provided: RECEIVE_CURRENT_USER, LOGOUT_CURRENT_USER, ERROR_HANDLER, login, logout, signUp */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ERROR_HANDLER", function() { return ERROR_HANDLER; });
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "Welcome to the Root page"), document.getElementById("root"));
});
...
var logout = function logout(user) {
  return $.ajax({
    method: "DELETE",
    url: "api/session/".concat(user.id)
  });
};
